# This file was generated by the {rix} R package v0.12.4 on 2024-10-24
# with following call:
# >rix(r_ver = "976fa3369d722e76f37c77493d99829540d43845",
#  > git_pkgs = list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "ff69fe20bf1cdf7c4f553546899d4e02ef9f49bd"),
#  > ide = "other",
  ...
  git_archive_pkgs = [
    (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "ff69fe20bf1cdf7c4f553546899d4e02ef9f49bd";
        sha256 = "sha256-m1zswP9avXkdpFY/uLMenBDyLGVT95HQk1MzFk4cNxA=";
      };
